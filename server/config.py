...
# Playback: "computer" = edge-tts on this machine, "esp32" = ESP32 speaker (Google TTS).
PLAYBACK_TARGET: Final[str] = os.getenv("PLAYBACK_TARGET", "computer").lower() or "computer"
